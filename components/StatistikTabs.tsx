...
// Statistik (Nutzer-Vorgabe 2026-08-09) - Spargel/Erdbeeren/Zuckermais,
// analog zu PraemienTabs (dort auch die Erklärung der ResizeObserver-
// Logik). Start mit Zuckermais, Spargel/Erdbeeren als "in Vorbereitung"-
// Platzhalter, sobald deren Prämien-Erfassung steht.
const tabs = [
...
export default function StatistikTabs() {
