...
const tabs = [
  { href: "/unterkunft", label: "Belegungsplan", exakt: true },
...
export default function UnterkunftTabs() {
  ...
  return (
    <div
      ref={ref}
      className="sticky top-14 z-40 -mt-6 flex flex-wrap gap-4 border-b border-neutral-200 bg-neutral-50 print:hidden"
    >
      {tabs.map((tab) => {
