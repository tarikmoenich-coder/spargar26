...
const de = {
  ...
  "erfassung.zeitengruppe": "Für ganze Gruppe:",
  "erfassung.zeitengruppesetzen": "Zeiten setzen",
  "erfassung.zeitengruppetitel":
    "Trägt die Zeiten bei allen Personen der Gruppe ein, die für den Tag noch keine Stunden und keine Markierung haben. Die Stunden werden daraus errechnet.",
  "erfassung.gruppezeitenleer": "Bitte mindestens Vormittag oder Nachmittag eintragen.",
  "erfassung.rundung": "Rundung",
  "erfassung.rundungviertel": "Viertelstunde",
  "erfassung.rundungminute": "Minutengenau",
  "erfassung.markierunganzeige": "Markierung (Urlaub) - wird im Controlling gepflegt",
  ...
  "suche.keineintrag": "kein Eintrag",
...
const hr: Record<TKey, string> = {
  ...
  "erfassung.zeitengruppe": "Za cijelu grupu:",
  "erfassung.zeitengruppesetzen": "Postavi vremena",
  "erfassung.zeitengruppetitel":
    "Upisuje vremena svim osobama u grupi koje za taj dan još nemaju sate ni oznaku. Sati se izračunavaju iz toga.",
  "erfassung.gruppezeitenleer": "Upišite barem prijepodne ili poslijepodne.",
  "erfassung.rundung": "Zaokruživanje",
  "erfassung.rundungviertel": "Četvrt sata",
  "erfassung.rundungminute": "Na minutu",
  "erfassung.markierunganzeige": "Oznaka (godišnji) - uređuje se u kontrolingu",
